...
static void startExecute(int _totalUser, int _totalTxs)
{
    ...
    std::cout << "init blockchain" << std::endl;
    ...
    std::cout << "got parentBlock" << std::endl;
	...
	serial_count += elapsed;
	//std::cout << "Executed: " << elapsed << " ms" << std::endl;
    }
    ...
    */
    ...
    auto avg_serial = (double)serial_count / 20;
    auto avg_para = (double)para_count / 20;
    //std::cout << "serial: " << avg_serial << " ms" << std::endl;
    //std::cout << "para: " << avg_para << " ms" << std::endl;
    //std::cout << "rate: " << (avg_serial / avg_para) << std::endl;
}
